        ...
        {isOpen && (
          ...
          >
            ...
            <motion.a
              ...
              rel="noopener noreferrer"
              onClick={() => handleOpenOption()}
              className="flex items-center space-x-3 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white px-4 py-3 rounded-2xl shadow-[0_10px_25px_rgba(220,39,67,0.35)] transition-all cursor-pointer group"
            >
              <div className="flex flex-col text-right">
                <span className="font-label-caps text-xs font-bold leading-tight">Instagram Oficial</span>
                <span className="text-[11px] opacity-90 font-mono">@studiosenhorele</span>
              </div>
