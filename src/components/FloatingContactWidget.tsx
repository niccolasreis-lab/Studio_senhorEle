        ...
        {isOpen && (
          ...
          >
            ...
            <motion.a
              ...
              aria-label="Conversar com o Studio SenhorEle pelo WhatsApp (abre em nova guia)"
              className="flex items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] text-deep-charcoal w-14 h-14 rounded-full shadow-[0_10px_25px_rgba(37,211,102,0.4)] transition-all cursor-pointer group focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-secondary"
            >
              <svg aria-hidden="true" className="w-8 h-8 fill-current" viewBox="0 0 24 24">
            ...
            <motion.a
              ...
              rel="noopener noreferrer"
              onClick={() => handleOpenOption()}
              aria-label="Visitar o Instagram do Studio SenhorEle (abre em nova guia)"
