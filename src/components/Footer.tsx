...
const WHATSAPP_UPDATES_URL =
  'https://wa.me/5511947251630?text=Ol%C3%A1%2C%20Studio%20Senhorele!%20Gostaria%20de%20receber%20novidades%20sobre%20o%20acervo.';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter pt-4">
          <div className="md:col-span-2 flex flex-col space-y-6">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <motion.button
                ...
                className="inline-flex items-center space-x-2 bg-secondary text-deep-charcoal font-label-caps text-label-caps px-5 py-2.5 rounded-lg hover:bg-amber-glow transition-colors cursor-pointer font-bold"
              >
          ...
          <div className="flex flex-col space-y-4 mt-8 md:mt-0">
            ...
            <button
              ...
              className="font-body-md text-body-md text-on-surface-variant hover:text-parchment underline underline-offset-4 transition-all text-left cursor-pointer"
            >
              {t.nav.inquire}
            </button>
          </div>
