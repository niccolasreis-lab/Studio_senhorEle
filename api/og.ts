...
import { findStaticShareItem, normalizeShareKey, type StaticShareItem } from './og-share-data';

type Handler = (req: any, res: any) => Promise<void> | void;

interface ShareItemResult extends StaticShareItem {
  siteUrl: string;
  redirectUrl: string;
}
